...
const FromAddress="rfbckFrRYtn7Q1ExRzJU9jdzEizfnQnE7c";
const FromSecret="ssZqmYWRg75UoYAa6E3fSfKUCb6dA";
const ToAddress="rGa7tyRD2se4yxJfru9EFY4QG9oKFjJ6o1";
const ToSecret="sntENaYDdBGDgb8LFuXSHjti3dJEY";
...
const trustline = {
  "currency": "BAS",
  "counterparty": "rfbckFrRYtn7Q1ExRzJU9jdzEizfnQnE7c",
  "limit": "1000",
  "qualityIn": 0.91,
  "qualityOut": 0.87,
...
export default class Trustlines extends React.Component<any, any> {
 ...
 public async setTrustlines(api){
  ...
  const trustline = {
    "currency": "USD",
    "counterparty": "rfZprtvKxsD15SAW7D4h1rwhNkM3HPwQrx",
    "limit": "1000",
    "qualityIn": 0.91,
    "qualityOut": 0.87,
    "ripplingDisabled": true,
